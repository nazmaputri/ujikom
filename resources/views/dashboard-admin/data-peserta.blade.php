            ...
            <table class="min-w-full border-collapse" id="userTable">
                <thead>
                    <tr class="bg-sky-100 text-gray-700 text-sm">
                        ...
                        <th class="py-2 border-b border-gray-200">Email</th>
                            ...
                            <td class="py-3 px-6 text-center border-b border-r border-gray-200">
                                <div class="flex items-center justify-center space-x-5">
                                    ...
                                    <form id="deleteForm" action="{{ route('datapeserta-admin.delete', $user->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="text-white bg-red-400 p-1 rounded-md hover:bg-red-300" onclick="openDeleteModal()" title="Hapus">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
...
<div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white p-6 rounded-lg shadow-lg mx-4">
        <h2 class="text-lg font-semibold text-gray-700 text-center">Konfirmasi Penghapusan</h2>
...
<script>
    ...
    //untuk membuka/menutup popup penghapusan data peserta
