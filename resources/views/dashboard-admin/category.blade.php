...
<div class="container mx-auto bg-white rounded-lg p-5">
    <h2 class="text-xl font-semibold mb-4 inline-block border-b-2 border-gray-300 pb-1 text-gray-700">Daftar Kategori</h2>
    ...
    <div class="mb-6 p-1 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 md:space-x-4">
        ...
        <!-- Tambah Kategori -->
        <a id="addCategoryButton" href="{{ route('categories.create') }}" class="inline-flex shadow-md shadow-sky-100 hover:shadow-none items-center space-x-2 text-white bg-sky-300 hover:bg-sky-200 font-bold py-2 px-4 rounded-md">
                    ...
                    @foreach($categories as $index => $category)
                        <tr class="bg-white hover:bg-sky-50 user-row">
                            ...
                            <td class="py-3 px-2 flex justify-center space-x-6">
                                <!-- Tombol Lihat Detail -->
                                <a href="{{ route('categories.show', $category->name) }}" class="text-white bg-sky-300 p-1 rounded-md hover:bg-sky-200">
                                ...
                                <!-- Tombol Edit -->
                                <a href="{{ route('categories.edit', $category->id) }}" class="text-white bg-yellow-300 p-1 rounded-md  hover:bg-yellow-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                    </svg>
                                </a>
                                <!-- Tombol Hapus -->
                                <button type="button" class="text-white bg-red-400 p-1 rounded-md hover:bg-red-300" onclick="openDeleteModal('{{ route('categories.destroy', $category->id) }}')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
