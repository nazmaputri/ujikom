...
<div class="container mx-auto">
    <div class="bg-white rounded-lg shadow-md p-6">
        <!-- Judul Halaman -->
        <h2 class="text-xl font-semibold text-gray-700 text-center w-full border-b-2 border-gray-300 pb-2">Tambah Kuis Baru</h2>
        ...
        <form action="{{ route('quiz.store', ['courseId' => $courseId, 'materiId' => $materiId]) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" class="w-full p-2 border rounded focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 text-gray-600" placeholder="Masukkan judul kuis" required>
            </div>
        
            <!-- Input untuk Deskripsi Kuis -->
            <div>
                <label for="description" class="block text-gray-700 font-bold mb-2">Deskripsi</label>
                <textarea name="description" id="description" rows="5" class="w-full p-2 border rounded focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 text-gray-600" placeholder="Masukkan deskripsi kuis" required></textarea>
            </div>
        
            <!-- Input untuk Waktu Pengerjaan Kuis -->
            <div>
                <label for="duration" class="block text-gray-700 font-bold mb-2">Durasi (menit)</label>
                <input type="number" name="duration" id="duration" class="w-full p-2 border rounded focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 text-gray-600 text-gray-600" placeholder="Masukkan durasi kuis (menit)" min="1" required>
            </div>
                ...
                <template id="question-template">
                    <div class="question-item border p-4 mb-4 rounded bg-gray-50">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="questions[0][question]" class="w-full p-2 border rounded question-input focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 text-gray-600" placeholder="Masukkan teks soal" required>
                        </div>
                        ...
                        <div class="answers-container">
                            ...
                            @for ($i = 0; $i < 4; $i++)
                                <div class="flex items-center mb-2">
                                    ...
                                    <input type="text" name="questions[0][answers][]" class="w-full text-gray-600 p-2 border focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 rounded answer-input" placeholder="Masukkan jawaban" required>
                                </div>
                            @endfor
                        </div>
