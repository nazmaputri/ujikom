                    ...
                    <tr class="bg-white hover:bg-sky-50 user-row">
                        ...
                        <td class="py-2 px-4 text-center">
                            <div class="flex items-center justify-center space-x-6">
                                ...
                                <!-- Tombol Lihat Detail -->
                                <a href="{{ route('courses.show', $course->id) }}" class="text-white bg-sky-300 p-1 rounded-md hover:bg-sky-200">
                                ...
                                <!-- Tombol Edit -->
                                <a href="{{ route('courses.edit', $course->id) }}" class="text-white bg-yellow-300 p-1 rounded-md hover:bg-yellow-200">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                ...
                                <form id="deleteForm" action="{{ route('courses.destroy', $course->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="text-white bg-red-400 p-1 rounded-md hover:bg-red-300" onclick="openDeleteModal({{ $course->id }})">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
