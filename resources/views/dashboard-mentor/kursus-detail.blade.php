        ...
        <h2 class="text-xl font-semibold mb-8 border-b-2 pb-2 text-gray-700 text-center">Detail Kursus</h2>
            ...
            <div class="flex flex-col lg:flex-row mb-4">
                ...
                <div class="mb-4 flex items-center justify-between p-1 border-t-2">
                    ...
                    <a href="{{ route('materi.create', ['courseId' => $course->id]) }}" class="mt-4 inline-flex shadow-md shadow-sky-100 hover:shadow-none items-center space-x-2 text-white bg-sky-300 hover:bg-sky-200 font-semibold py-2 px-4 rounded-md">
                                ...
                                <tr class="bg-white hover:bg-sky-50 user-row text-sm text-gray-600">
                                    ...
                                    <td class="py-2 px-4 text-center border-b  border-r border-gray-200">
                                        <div class="flex items-center justify-center space-x-6">
                                            ...
                                            <a href="{{ route('materi.edit', ['courseId' => $course->id, $materiItem->id]) }}" class="text-white bg-yellow-300 p-1 rounded-md hover:bg-yellow-200">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
