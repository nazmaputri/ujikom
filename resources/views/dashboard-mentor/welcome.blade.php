...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
        ...
        <div class="bg-red-100 rounded-lg shadow-md p-5 flex items-center">
            ...
            <div class="ml-4">
                <h2 class="text-xl font-semibold text-red-700">Jumlah Peserta</h2>
                <p class="text-md font-semibold text-red-600">{{ $jumlahPeserta }} Peserta</p> <!-- Menampilkan jumlah peserta -->
            </div>
        </div>
        ...
        <div class="bg-yellow-100 rounded-lg shadow-md p-5 flex items-center">
            ...
            <div class="ml-4">
                <h2 class="text-xl font-semibold text-yellow-700">Jumlah Kursus</h2>
                <p class="text-md font-semibold text-yellow-600">{{ $jumlahKursus }} Kursus</p> <!-- Menampilkan jumlah kursus -->
            </div>
        </div>
        ...
        <div class="bg-blue-100 rounded-lg shadow-md p-5 flex items-center">
            <div class="p-2 bg-blue-500 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 512 512" stroke="currentColor" fill="white">
            ...
            <div class="ml-4">
                <h2 class="text-xl font-semibold text-blue-700">Jumlah Materi</h2>
