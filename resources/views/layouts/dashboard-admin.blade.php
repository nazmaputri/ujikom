    ...
    <div class="flex h-screen" x-data="{ sidebarOpen: false }">
        ...
        <!-- logo -->
            ...
            <nav class="">
                ...
                <a href="" class="block">
                    <li class="flex items-center px-4 py-2 hover:bg-sky-200 rounded-xl space-x-4">
                    ...
                    <!-- Memeriksa apakah pengguna sudah login -->
                        ...
                        <div class="relative">
                            <button id="dropdown-button" class="text-gray-600 focus:outline-none">
                                <img width="22" height="22" src="https://img.icons8.com/windows/32/circled-chevron-down.png" alt="-"/>
                            </button>
                            <div id="dropdown" class="hidden absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg z-10">
                                <ul class="py-1 space-y-1" aria-labelledby="dropdown-button">
                                    <li>
                                        <a href="{{ route('settings.admin') }}" class="block flex items-center p-1 text-sm text-gray-700 hover:bg-sky-200 rounded-xl mx-2">
