        ...
        <div 
            ...
            <nav class="">
                ...
                <a href="{{ route('welcome-peserta') }}" class="block">
                    <li class="flex items-center px-4 py-2 rounded-xl space-x-4 {{ Request::routeIs('welcome-peserta') ? 'bg-sky-300' : 'hover:bg-sky-200' }}">
                ...
                <a href="{{ route('kategori-peserta') }}" class="block">
                    <li class="flex items-center px-4 py-2 rounded-xl space-x-4 {{ Request::routeIs('kategori-peserta', 'categories-detail', 'kursus-peserta') ? 'bg-sky-300' : 'hover:bg-sky-200' }}">
                ...
                <a href="{{ route ('daftar-kursus') }}" class="block"class="block">
                    <li class="flex items-center px-4 py-2 rounded-xl space-x-4 {{ Request::routeIs('daftar-kursus', 'detail-kursus', 'study-peserta', 'chat.student', 'quiz.show', 'quiz.result') ? 'bg-sky-300' : 'hover:bg-sky-200' }}">
            ...
            <header class="bg-white shadow p-2 flex items-center justify-start">
                ...
                <div id="dropdown" class="hidden absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg z-10">
                    <ul class="py-1 space-y-1">
                        <li>
                            <a href="{{ route('settings-student') }}" class="block flex items-center p-1 text-sm text-gray-700 hover:bg-sky-200 rounded-xl mx-2">
                        ...
                        <li>
                            <a class="block flex items-center p-1 text-sm text-red-500 hover:bg-red-500 hover:text-white rounded-xl mx-2">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 m-2 fill-current">
                                ...
                                <form action="{{ route('logout') }}" method="GET" class="w-full">
                                    @csrf
                                    <button type="submit" class="w-full text-left py-1.5 text-sm">Keluar</button>
                                </form>
                            </a>
                        </li>
                    </ul>                            
